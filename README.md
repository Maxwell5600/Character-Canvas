...
Disclaimer 
==================================================================================
Entirely Vibe coded. Unlike Persona Library that is mostly vibe codded with the help of some human coding this doesn't have that added luxury i had it made in some of my spare time just because i Could there was some interest expressed in something like this and i wanted something slightly less featureful than character Library to use in Conjunction with character library The Most of this read Me was Composed by Claude as well this section i completely typed up myself. anywhere where i added my own two cents has a note denoting it was written by me (Written By Maxwell) like such and Like wise the few screenshots were taken by me as well. 
